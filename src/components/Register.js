...
const Register = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://moneymanager-acen.onrender.com/api/register", {
        name: formData.name,
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-white">
      <form onSubmit={handleFormSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-15 mt-28 w-96 z-40">
        <h2 className="text-2xl font-semibold mb-4 text-indigo-500">Money Manager</h2>
        <div className="mb-2">
